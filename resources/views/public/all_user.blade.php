    ...
    <section class="clean-block features">
        <div class="container">
            <div class="block-heading">
                ...
                <p>All the user name, blood group and city are provided here.</p>
            </div>
                ...
                <table class="table table-hover table-bordered results">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="{{URL::to('/ban-user/'.$d_info->user_id)}}" class="primary-btn btn" style="background-color:red;color:white;">Ban User</a></td>
                        </tr>
                    </tbody>
                </table>
